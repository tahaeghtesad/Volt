...
class ReusablePool:
    ...
    def acquire(self):
        self.logger.debug(f'Acquiring an instance. Running: {self.created - self.deleted}')
        self.created += 1
        return self.constructor(self.created)

    def release(self, reusable):
        self.logger.debug(f'Releasing an instance. Running: {self.created - self.deleted}')
        self.deleted += 1
